...
! function(a, b) {
  ...
  return b.defaults = {
    ...
    function c() {
      var dataContainer      = d.$lightbox.find(".lb-dataContainer"),
          containerWidth     = d.$lightbox.find(".lb-outerContainer").outerWidth(),
          dataContainerStyle = window.getComputedStyle(dataContainer.get(0));

      dataContainer.width(containerWidth - parseFloat(dataContainerStyle['padding-left']) - parseFloat(dataContainerStyle['padding-right'])), d.$lightbox.find(".lb-prevLink").height(h), d.$lightbox.find(".lb-nextLink").height(h), d.showImage()
    }
    var d = this,
